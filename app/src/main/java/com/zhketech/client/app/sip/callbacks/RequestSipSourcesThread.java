    ...
    public void run() {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(sipStrServer)){
                SharedPreferencesUtils.putObject(ZkthApp.getInstance(),"sip_server_ip",sipStrServer);
            ...
            if (!TextUtils.isEmpty(sipStrName)){
                SharedPreferencesUtils.putObject(ZkthApp.getInstance(),"sip_name",sipStrName);
            }
            ...
            if (!TextUtils.isEmpty(sipStrPass)){
                SharedPreferencesUtils.putObject(ZkthApp.getInstance(),"sip_pass",sipStrPass);
            }
